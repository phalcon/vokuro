...
<table border="0" cellspacing="0" width="530" style="color:#262626;background-color:#fff;
    ...
    <tr style="background:#D44413">
        <td style="padding-left:20px">
            <a target="_blank"
               style="text-decoration:none;color:inherit;font-family:'HelveticaNeue','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:normal;">
                ...
                <tr style="border-bottom:1px solid #999999;">
                    <td width="24" style="padding:0 7px 0 0;">
                        <a href="http://www.facebook.com/pages/Phalcon/134230726685897" style="border-width:0;">
                            <img src="http://{{ publicUrl }}/img/facebook.gif" width="24" height="24"
                                 alt="Facebook Image">
                        </a>
                    </td>
                    <td width="24">
                        <a href="http://twitter.com/phalconphp" style="border-width:0;">
                            <img src="http://{{ publicUrl }}/img/twitter.gif" width="24" height="24"
                                 alt="Twitter Image">
                        </a>
                    </td>
                </tr>
