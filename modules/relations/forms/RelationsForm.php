...
namespace Modules\Relations\Forms;
...
class RelationsForm extends Form
{
  ...
  public function initialize($entity = null, array $options = []) {
    ...
    */
    ...
    // id
    // We don't need to add the ID when we are Adding a new Relation, only when we are editing a new Relation
    ...
    $companyname->setLabel("Relation Name");
